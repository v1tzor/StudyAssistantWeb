        ...
        <div className="flex flex-col items-center">
          <div className="mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
            ...
            <p className="text-medium">
              Monitor your weekly workload effortlessly from the home screen.
              Gain insights into your tasks to enhance your productivity.
            </p>
          </div>
          <div className="grid grid-cols-1 items-start justify-center gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
            <div className="flex w-full flex-col items-center text-center">
              ...
              <p>Get detailed statistics to plan your time effectively.</p>
            </div>
            <div className="flex w-full flex-col items-center text-center">
              <div className="mb-5 md:mb-6">
                <RelumeIcon className="size-12 text-scheme-text" />
            ...
            <div className="flex w-full flex-col items-center text-center">
              ...
              <p>Use insights to adjust your study habits.</p>
            </div>
          </div>
